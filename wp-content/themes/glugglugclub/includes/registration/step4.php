...
<div id="ggc_step4" class="row clearfix">

<div id="confirmationstep" class="col-md-10 col-md-offset-1 col-xs-12">

<?php include('wp-content/themes/glugglugclub/includes/partials/profileconfirm_modal.php');?>
...
var inst = jQuery('[data-remodal-id=profileconfirm]').remodal(
{
