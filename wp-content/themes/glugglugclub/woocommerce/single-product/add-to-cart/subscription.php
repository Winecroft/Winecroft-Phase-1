...
if ( ! $product->is_in_stock() ) : ?>
	...
	<span class="primary_btn outofstock_btn">Out of Stock</span>
<?php else : ?>

	<link itemprop="availability" href="http://schema.org/InStock">

	<?php do_action( 'woocommerce_before_add_to_cart_form' ); ?>
<?php /**nope dont need this anymore doing it our own way!
	...
	<form class="cart" method="post" enctype='multipart/form-data'>
		...
		<button type="submit" class="single_add_to_cart_button primary_btn bttn"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
...
**/?>
	...
	<?php //include('/../../box/amendbox.php');?>
	<?php //include('/../../box/amendbox_js.php');?>


	<?php require dirname( __FILE__ ) . '/../../box/amendbox.php';?>
	<?php require dirname( __FILE__ ) . '/../../box/amendbox_js.php';?>
	<?php if (!is_user_logged_in() ):?>
	<div class="login_area text-center">
		<p>Already a member? <a href="#signin">Login now</a></p>
	</div>
	<?php endif;?>
