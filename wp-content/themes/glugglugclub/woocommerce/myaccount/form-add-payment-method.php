...
?>
	<div id="payment_method_update" class="col-md-6 col-md-offset-3 col-xs-12">
		<div class="white_box_holder">
			<div class="account_form_heading"><h3>Add Payment Method</h3></div>
<?php
	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<input type="submit" class="primary_btn fullwidth bttn" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?>" />
