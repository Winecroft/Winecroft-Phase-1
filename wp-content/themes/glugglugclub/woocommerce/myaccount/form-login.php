...
<?php endif; ?>
		...
		<form class="" method="post">
			...
			<p class="form-row">
				...
				<input type="submit" class="primary_btn bttn" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
				<?php /**
...
<?php if (( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) AND (!isset($_GET['password-reset']) && count($_GET) > 1 )) : ?>
	...
	<div class="">
		...
		<form method="post" class="">
			...
			<p class="woocommerce-FormRow form-row">
				...
				<input type="submit" class="primary_btn bttn" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
			</p>
