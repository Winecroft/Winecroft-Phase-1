...
<div id="ordersingle" class="account_form clearfix">
	<h3 class="account_form_heading">Subscription Details</h3>
		...
		<tr class="actionsrow">
			...
			<td>
				<?php foreach ( $actions as $key => $action ) : ?>
					<a href="<?php echo esc_url( $action['url'] ); ?>" style="margin-left:15px" class="primary_btn minibttn pull-right <?php echo sanitize_html_class( $key ) ?>"><?php echo esc_html( $action['name'] ); ?></a>
				<?php endforeach; ?>
			</td>
		</tr>
	<?php endif; ?>
