...
<div class="container clearfix">
    <div class="account_profile col-md-8 col-xs-12">
...
<div class="gens-refer-a-friend" data-link="<?php echo $rafLink; ?>">
    ...
    <?php /**<div id="gens-raf-message"><?php _e( 'Your Referral URL:','gens-raf'); ?> <strong><?php echo $rafLink; ?></strong><span class="gens-ctc" data-text="<?php _e('Copied!','gens-raf'); ?>"><?php _e("Click to copy","gens-raf"); ?></span></div>**/?>
    <?php 
        if($referral_code === "yes") {
    ?>
    <div id="gens-raf-message"><?php _e( 'Your Coupon Code to share:','gens-raf'); ?> <strong><?php echo $raf_id; ?></strong><span class="gens-ctc" data-text="<?php _e('Copied!','gens-raf'); ?>"><?php _e("Click to copy","gens-raf"); ?></span></div>
    <?php 
        }
        do_action('gens_after_referral_url');
    ?>
    <div class="gens-referral_share">
        <a href="<?php echo site_url();?>/getting-started/step-1/" class="gens-referral_share__fb" data-message="Use code <?php echo $raf_id;?> to get an additional £10 off your first order!"><i class="gens_raf_icn-facebook"></i> <?php _e("Share via Facebook","gens-raf"); ?></a>
        <a href="<?php echo site_url();?>/getting-started/step-1/" class="gens-referral_share__tw" data-via="<?php echo $twitter_via; ?>" data-title="Use code <?php echo $raf_id;?> to get an additional £10 off your first order!" ><i class="gens_raf_icn-twitter"></i> <?php _e("Share via Twitter","gens-raf"); ?></a>
      <!-- <a href="<?php echo site_url();?>/getting-started/step-1/" class="gens-referral_share__gp"><i class="gens_raf_icn-gplus"></i> <?php _e("Share via Google+","gens-raf"); ?></a>-->
        <a href="<?php echo site_url();?>/getting-started/step-1/" class="gens-referral_share__wa" data-title="Use code <?php echo $raf_id;?> to get an additional £10 off your first order!"><i class="gens_raf_icn-whatsapp"></i> <?php _e("Share via Whatsapp","gens-raf"); ?></a>
    </div>
...
<?php require dirname( __FILE__ ) . '/../woocommerce/myaccount/account-mini-profile.php';?>
</div>