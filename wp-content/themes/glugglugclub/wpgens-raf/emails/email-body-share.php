...
<tbody>
    ...
    <tr>
        <?php 
            $whatIWant = substr($refLink, strpos($refLink, "=") + 1);    
                ...
                <tbody>
                    <tr>
                        <td align="center" width="200" height="40" bgcolor="<?php echo $color;?>" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                            <a href="http://88.208.192.245/~winecroft/getting-started/step-1#refered" style="font-size:16px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; text-transform:uppercase;line-height:40px; width:100%; display:inline-block"><span style="color: #FFFFFF"><?php _e('Shop Now','gens-raf'); ?></span></a>
                        </td>
                    </tr>
                </tbody>
            </table>
