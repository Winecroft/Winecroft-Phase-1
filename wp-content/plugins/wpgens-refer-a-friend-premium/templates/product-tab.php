<?php
/**
 * Refer a Friend Product Tab HTML
 *
 * Available variables: $rafLink (Referral link), $share_text(share text option), $title (twitter title option), $twitter_via(twitter via option)
 *
...
<div class="gens-refer-a-friend" data-link="<?php echo $rafLink; ?>">
    ...
    <div id="gens-raf-message"><?php _e( 'Your Referral URL:','gens-raf'); ?> <strong><?php echo $rafLink; ?></strong><span class="gens-ctc" data-text="<?php _e('Copied!','gens-raf'); ?>"><?php _e("Click to copy","gens-raf"); ?></span></div>
    <?php 
