				...
				<div id="gift-certificate-receiver-form-single">
					<div class="form_table">
						<div class="email_amount">
							...
							<div class="email"><input class="gift_receiver_email" type="text" placeholder="<?php _e( 'Email address', WC_SC_TEXT_DOMAIN ); ?>..." name="gift_receiver_email[0][0]" value="<?php echo $_COOKIE['giftemail'];?>" /></div>
						</div>
						<div class="message_row">
							<div class="message"><textarea placeholder="<?php _e( 'Message', WC_SC_TEXT_DOMAIN ); ?>..." class="gift_receiver_message" name="gift_receiver_message[0][0]" cols="50" rows="5"><?php echo $_COOKIE['giftmessage'];?></textarea></div>
						</div>
					</div>
				</div>
				</div></div>
